...
public class Jakob extends Person{
	...
	public Jakob(int xPos, int yPos) {
		...
		hpImage = new BufferedImage(70, 9, BufferedImage.TYPE_INT_RGB);
	...
	public void renderHp(Screen screen) {
		screen.renderImage(renderHpImage(), (int)xPos + playerImage.getWidth()/2 - hpImage.getWidth()/2, (int)yPos - 13, 1, 1);
	}
	...
	private BufferedImage renderHpImage() {
		...
		graphics.setFont(new Font("Calibri", Font.TRUETYPE_FONT, 9));
